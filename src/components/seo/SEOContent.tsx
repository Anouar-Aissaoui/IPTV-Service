  ...
  return (
    <div className="prose prose-invert max-w-none">
      <section className="py-8">
        <h2 className="text-2xl font-bold mb-4">Best IPTV Service Features</h2>
        <p className="mb-4">
          Experience the ultimate streaming solution with our <Link to="/pricing" className="text-neon hover:underline">premium IPTV subscription</Link>. 
          Access over 40,000 live channels and 54,000+ VOD content in stunning HD and 4K quality. Our IPTV service provides comprehensive coverage of 
          <Link to="/channels" className="text-neon hover:underline"> sports, movies, TV shows, news</Link>, and international programming.
        </p>
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>24/7 <Link to="/faq" className="text-neon hover:underline">technical support</Link></li>
      ...
      <section className="py-8">
        <h2 className="text-2xl font-bold mb-4">Why Choose Our IPTV Subscription?</h2>
        <p className="mb-4">
          ...
          commitment to customer satisfaction. Check our <Link to="/faq" className="text-neon hover:underline">FAQ section</Link> for 
          more details.
        </p>
