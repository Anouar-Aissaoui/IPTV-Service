      ...
      <div className="container mx-auto px-4 py-8 md:py-12 lg:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-8 md:mt-12">
          <div className="bg-dark border-4 border-[#F97316] p-3 sm:p-4 md:p-6 transform hover:-translate-y-1 hover:translate-x-1 transition-transform duration-200 shadow-[8px_8px_0px_0px_rgba(249,115,22,1)]">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white transform -rotate-2">+7K</div>
            <div className="text-[#F97316] text-xs sm:text-sm font-semibold transform rotate-1">{t('stats.customers')}</div>
          </div>
          <div className="bg-dark border-4 border-[#F97316] p-3 sm:p-4 md:p-6 transform hover:-translate-y-1 hover:translate-x-1 transition-transform duration-200 shadow-[8px_8px_0px_0px_rgba(249,115,22,1)]">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white transform rotate-2">+40K</div>
            <div className="text-[#F97316] text-xs sm:text-sm font-semibold transform -rotate-1">{t('stats.channels')}</div>
          </div>
          <div className="bg-dark border-4 border-[#F97316] p-3 sm:p-4 md:p-6 transform hover:-translate-y-1 hover:translate-x-1 transition-transform duration-200 shadow-[8px_8px_0px_0px_rgba(249,115,22,1)]">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white transform -rotate-2">+1,500</div>
            <div className="text-[#F97316] text-xs sm:text-sm font-semibold transform rotate-1">{t('stats.sports')}</div>
          </div>
          <div className="bg-dark border-4 border-[#F97316] p-3 sm:p-4 md:p-6 transform hover:-translate-y-1 hover:translate-x-1 transition-transform duration-200 shadow-[8px_8px_0px_0px_rgba(249,115,22,1)]">
            <div className="text-xl sm:text-2xl md:text-3xl font-bold text-white transform rotate-2">+54K</div>
            <div className="text-[#F97316] text-xs sm:text-sm font-semibold transform -rotate-1">{t('stats.vod')}</div>
          </div>
        </div>
      </div>
