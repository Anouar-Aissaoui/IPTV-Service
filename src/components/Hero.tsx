...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative bg-dark">
      ...
      <div className="container mx-auto px-4 py-6 md:py-12 lg:py-16 safe-area-inset">
          ...
          <div className="w-full lg:w-1/2 space-y-4 md:space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button 
                ...
                className="w-full sm:w-auto bg-[#F97316] text-white hover:bg-[#F97316]/90 text-sm md:text-base px-6 py-4 font-bold transform hover:-translate-y-1 hover:translate-x-1 transition-transform duration-200 border-4 border-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none min-h-[48px] touch-manipulation"
              >
                {t('hero.cta.trial')}
              </button>
              <button 
                onClick={handleWhatsAppClick}
                className="w-full sm:w-auto bg-dark border-4 border-[#F97316] text-white hover:bg-[#F97316] hover:text-white text-sm md:text-base px-6 py-4 font-bold flex items-center justify-center gap-2 transform hover:-translate-y-1 hover:translate-x-1 transition-transform duration-200 shadow-[8px_8px_0px_0px_rgba(249,115,22,1)] rounded-none min-h-[48px] touch-manipulation"
              >
                <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
