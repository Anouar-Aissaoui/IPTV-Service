    ...
    <div className="relative bg-dark">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="lg:w-1/2 space-y-6">
            ...
            <p className="text-lg leading-relaxed animate-fade-in delay-100 text-gray-300">
            ...
            <div className="flex flex-col sm:flex-row gap-3 animate-fade-in delay-200">
              <Button 
                className="bg-neon text-dark hover:bg-neon/90 text-lg px-8 py-6 font-bold shadow-lg shadow-neon/20 transform hover:scale-105 transition-all duration-200"
              >
                Start Free Trial Now
              </Button>
              <Button 
                onClick={handleWhatsAppClick}
                className="bg-green-500 text-white hover:bg-green-600 text-lg px-8 py-6 font-bold flex items-center gap-3 shadow-lg shadow-green-500/20 transform hover:scale-105 transition-all duration-200"
              >
            ...
            <div className="space-y-4 animate-fade-in delay-300">
              <div className="bg-dark-gray/50 p-4 rounded-xl border border-neon/20">
                <BlurImage 
                  src="https://www.iptvthemes.shop/shadowstream/wp-content/uploads/2023/12/devices-4.webp"
                  alt="Supported Devices"
                  className="w-full max-w-[300px] h-auto hover:scale-105 transition-transform duration-300"
                />
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div className="space-y-1 bg-dark-gray/30 p-4 rounded-xl hover:bg-dark-gray/40 transition-colors duration-300">
            <div className="text-3xl font-bold text-white animate-pulse">+7K</div>
            <div className="text-neon font-medium">Happy Customers</div>
          </div>
          <div className="space-y-1 bg-dark-gray/30 p-4 rounded-xl hover:bg-dark-gray/40 transition-colors duration-300">
            <div className="text-3xl font-bold text-white animate-pulse">+40K</div>
            <div className="text-neon font-medium">Channels</div>
          </div>
          <div className="space-y-1 bg-dark-gray/30 p-4 rounded-xl hover:bg-dark-gray/40 transition-colors duration-300">
            <div className="text-3xl font-bold text-white animate-pulse">+1,500</div>
            <div className="text-neon font-medium">Sport Channels</div>
          </div>
          <div className="space-y-1 bg-dark-gray/30 p-4 rounded-xl hover:bg-dark-gray/40 transition-colors duration-300">
            <div className="text-3xl font-bold text-white animate-pulse">+54K</div>
