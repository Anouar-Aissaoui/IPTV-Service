  ...
  return (
    <div className="relative bg-dark">
      ...
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <Button className="bg-[#F97316] text-white hover:bg-[#F97316]/90 shadow-lg shadow-[#F97316]/30 font-bold transform hover:scale-105 transition-all duration-300">
          Free Trial
        </Button>
      </nav>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="lg:w-1/2 space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight animate-fade-in">
              ...
              <span className="text-[#F97316] bg-gradient-to-r from-[#F97316] to-neon bg-clip-text text-transparent">Affordable Price</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                className="bg-[#F97316] text-white hover:bg-[#F97316]/90 text-lg px-8 py-6 font-bold shadow-lg shadow-[#F97316]/30 transform hover:scale-105 transition-all duration-300 animate-pulse"
              >
                Start Free Trial Now
              </Button>
              <Button 
                onClick={handleWhatsAppClick}
                className="bg-dark border-2 border-[#F97316] text-white hover:bg-[#F97316] hover:text-white text-lg px-8 py-6 font-bold flex items-center gap-2 transition-all duration-300 transform hover:scale-105"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
          <div className="bg-dark border border-[#F97316]/20 p-6 rounded-xl hover:border-[#F97316] hover:scale-105 transition-all duration-300">
            <div className="text-3xl font-bold text-white">+7K</div>
            <div className="text-[#F97316] text-sm font-semibold">Happy Customers</div>
          </div>
          <div className="bg-dark border border-[#F97316]/20 p-6 rounded-xl hover:border-[#F97316] hover:scale-105 transition-all duration-300">
            <div className="text-3xl font-bold text-white">+40K</div>
            <div className="text-[#F97316] text-sm font-semibold">Channels</div>
          </div>
          <div className="bg-dark border border-[#F97316]/20 p-6 rounded-xl hover:border-[#F97316] hover:scale-105 transition-all duration-300">
            <div className="text-3xl font-bold text-white">+1,500</div>
            <div className="text-[#F97316] text-sm font-semibold">Sport Channels</div>
          </div>
          <div className="bg-dark border border-[#F97316]/20 p-6 rounded-xl hover:border-[#F97316] hover:scale-105 transition-all duration-300">
            <div className="text-3xl font-bold text-white">+54K</div>
            <div className="text-[#F97316] text-sm font-semibold">Movies & TV Shows</div>
          </div>
        </div>
      </div>
